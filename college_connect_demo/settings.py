...
DEBUG = False
ALLOWED_HOSTS = ['*']  # free Heroku subdomain, no domain yet
...
# CHANNELS (in-memory for free Heroku)
CHANNEL_LAYERS = {
    "default": {
...
SECURE_SSL_REDIRECT = False  # free Heroku does not provide HTTPS on free tier
